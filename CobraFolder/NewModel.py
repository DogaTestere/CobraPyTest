...
glc_EX = create_metabolites("glc_e","C6H12O6","Glucose","e")
...
R_5319 = create_reaction("R13199","alpha-D-glucose-6-phosphate aldose-ketose-isomerase","(b4025)",{glc_p:-1.0,frc_p:1.0})
...
R_41213 = create_reaction("R01068","D-fructose-1,6-bisphosphate D-glyceraldehyde-3-phosphate-lyase (glycerone-phosphate-forming)","(b2097 or b2925)",{frc_dp:-1.0,glyc_p:1.0,glycal_p:1.0})

R_5111 = create_reaction("R01015","D-glyceraldehyde-3-phosphate aldose-ketose-isomerase","(b3919)",{glycal_p:-1.0,glyc_p:1.0})
...
R_12112 = create_reaction("R01061","D-glyceraldehyde-3-phosphate:NAD+ oxidoreductase (phosphorylating)","(b1779)",{glycal_p:-1.0,pi:-1.0,nad:-1.0,glyclr_p:1.0,nadh:1.0,h:1.0})

glyclr3_p = create_metabolites("glyclr3_p","C3H7O7P","3-Phospho-D-glycerate","c")

R_2723 = create_reaction("R01512","ATP:3-phospho-D-glycerate 1-phosphotransferase","(b2926)",{glyclr_p:-1.0,atp:-1.0,glyclr3_p:1.0,adp:1.0})

glyclr2_p = create_metabolites("glyclr2_p","C3H7O7P","2-Phospho-D-glycerate","c")

R_54211 = create_reaction("R01518","D-phosphoglycerate 2,3-phosphomutase","(b0755 or b4395)",{glyclr2_p:-1.0,glyclr3_p:1.0})

R_54212 = create_reaction("R01518","D-phosphoglycerate 2,3-phosphomutase","(b3612)",{glyclr2_p:-1.0,glyclr3_p:1.0})

pep = create_metabolites("pep","C3H5O6P","Phosphoenolpyruvate","c")

R_42111 = create_reaction("R00658","2-phospho-D-glycerate hydro-lyase (phosphoenolpyruvate-forming)","(b2779)",{glyclr2_p:-1.0,pep:1.0,h2o:1.0})
